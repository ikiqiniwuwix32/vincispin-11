...
function denyWager(message){verdictView.textContent=message;wagerInput.classList.remove('rl-deny-05f8becc');void wagerInput.offsetWidth;wagerInput.classList.add('rl-deny-05f8becc');}
...
function clearFlash(){dieView.classList.remove('rl-win-05f8becc');dieView.classList.remove('rl-lose-05f8becc');if(frameEl){frameEl.classList.remove('rl-win-05f8becc');frameEl.classList.remove('rl-lose-05f8becc');}}
function flashOutcome(won){clearFlash();if(won){dieView.classList.add('rl-win-05f8becc');if(frameEl){frameEl.classList.add('rl-win-05f8becc');}}else{dieView.classList.add('rl-lose-05f8becc');if(frameEl){frameEl.classList.add('rl-lose-05f8becc');}}
...
var brandEl=document.querySelector('.rl-brand-05f8becc');var echoEl=grab('rl-echo');if(brandEl&&echoEl){echoEl.textContent=brandEl.textContent.replace(/\s+/g,' ').trim();}
